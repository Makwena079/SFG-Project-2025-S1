...
$requests = mysqli_query($conn, "SELECT * FROM maintenance_requests WHERE user_id = {$user['id']}");
...
<main class="ms-md-5 p-4">
    <div class="container">
        ...
        <form method="POST" action="../backend/add_maintenance.php" class="mb-5">
            <div class="mb-3">
